...
| **Solution**                                                                                                                                                                                      | **Pros**                                                                                                                                    | **Cons**                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| ![](LP3985.png)<br>\* Option 1.<br><br>\* LP3985 Micropower, 150-mA Low-Noise Ultra-Low-Dropout CMOS Voltage Regulator <br><br>\* $0.45/each <br><br>\* [link to product](https://www.mouser.com/ProductDetail/Texas-Instruments/LP3985IM5-28-NOPB?qs=1FNqv8aZn1RHlx0XcZV7CQ%3D%3D&mgh=1&utm_id=17222215321&utm_source=google&utm_medium=cpc&utm_marketing_tactic=amercorp&gad_source=1&gclid=CjwKCAiAlPu9BhAjEiwA5NDSA1-lmcOVf7dfIfJtHzIcH-mckVNu4x45atozwo4YggQ7jqQqmPgLqhoCDSAQAvD_BwE)                 | \* Performance is optimized for battery-powered systems to deliver ultra-low noise<br>\* Regulator ground current increases only slightly in dropout<br>\* Delivers extremely small dropout voltage| \* ---<br>\* --- |
